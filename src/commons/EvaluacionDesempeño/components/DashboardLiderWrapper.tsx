...
import DashboardLider from './DashboardLider.tsx';
import { Box, Typography, Paper, Alert } from '@mui/material';
import { Block } from '@mui/icons-material';

const DashboardLiderWrapper: React.FC = () => {
    ...
    const verificarRol = async () => {
      try {
        ...
        if (perfilResponse.ok) {
          ...
          console.log('🔍 Valor de es_lider:', perfil.perfil?.es_lider);
          console.log('🔍 Tipo de es_lider:', typeof perfil.perfil?.es_lider);
          console.log('🔍 Comparación es_lider === true:', perfil.perfil?.es_lider === true);
          setEsLider(perfil.perfil?.es_lider === true);
        } else {
          console.log('⚠️ Error en la respuesta del perfil');
          setEsLider(false);
        }
      } catch (error) {
  ...
  return <DashboardLider liderId={liderId!} />;
};

export default DashboardLiderWrapper;
